...
(defun sketch--create-canvas (width height &optional grid-param minor-grid-freq)
  ...
  (let* (svg
         ...
         (minor-grid (dom-node 'pattern
                               `((id . "minorGrid")
                                 ...
                                 (patternUnits . "userSpaceOnUse"))
                               (dom-node 'rect `((width . ,minor-grid-param) (height . ,minor-grid-param)
                                                 (x . 0) (y . 0)
